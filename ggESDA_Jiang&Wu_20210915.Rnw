...
\begin{figure}[htbp]
    \centering 
    \includegraphics[width=0.85\textwidth,clip]{indexImage_2case.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[trim=3cm 0.25cm 3cm 0cm,width=1\textwidth,clip]{ggESDA_Jiang&Wu_20210915-2Dhist.pdf
}
...
\begin{figure}[htbp]
\centering
\includegraphics[trim=0cm 0.4cm 0cm 1.5cm,width=0.9\textwidth,clip]{ggESDA_Jiang&Wu_20210915-2DhistMatrix.pdf
}
...
\begin{figure}[htbp]
\centering
\includegraphics[trim=0cm 2cm 0cm 3.5cm,width=1\textwidth, clip]{radar_3obs.pdf} 
