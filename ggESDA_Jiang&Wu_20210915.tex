...
For exploring data, we extend the index plot into full variables using face dataset and visualize by color mapping as we did before. Figure \ref{fig:indexImage} shows 
